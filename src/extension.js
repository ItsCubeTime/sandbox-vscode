    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function prepareWorkspace(overwrite) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                // @note T o create a boolean property, add something like the following to package.json under contributes > properties
                // "myExtension.enableFeature": {
                //   "type": "boolean",
                //   "default": true,
                //   "description": "Enable the super cool feature in My Extension"
                // },
                // @note then you will be able to access your new property like so:
                // const isEnabled = config.get<boolean>('enableFeature', true);
                let defaultHtmlContent = config.get('defaultHtmlContent') || `<!--You can change the default content of these files by adding the following to your settings.json: "sandbox": {"defaultHtmlContent": "Some html","defaultCssContent": "Some css","defaultJsContent": "Some js",},-->
<div class="foo">foo</div>
<div class="bar">bar</div>
<div class="baz">baz</div>
<div class="qux">
    <div class="quux">quux</div>
    <div class="quux">quux</div>
    <div class="quux">quux</div>
    <div class="quux">quux</div>
    <div class="quux">quux</div>
...
<div id="output"></div>`;
                let defaultCssContent = config.get('defaultCssContent') || `.foo
{
...
.quux
{
    background-color: pink;
                ...
                let defaultJsContent = config.get('defaultJsContent')||`for (let el of document.getElementsByClassName('foo'))
{
    el.addEventListener("click",()=>{
        document.getElementById('output').innerHTML+='foo<br>'
    });
}`;
                
                for (let docPair of [[docHTML, defaultHtmlContent], [docJS, defaultJsContent], [docCSS, defaultCssContent]]) {
                    let document = docPair[0];
                    let newContent = docPair[1];
